...
import { Mail, Send, Share2, MessageCircle } from 'lucide-react'
...
export default function Contact() {
  ...
  const onSubmit = (e) => {
    ...
    toast.textContent = 'Opening your email app to send… ✦'
          ...
          <div className={styles.intro}>
            ...
            <div className={`${styles.directs} contact-reveal`}>
              ...
              <div className={styles.socials}>
                <a href="https://instagram.com/elysianstudios" target="_blank" rel="noopener" aria-label="Instagram"><Share2 size={16} /></a>
                <a href="https://x.com/elysianstudios" target="_blank" rel="noopener" aria-label="X / Twitter"><MessageCircle size={16} /></a>
              </div>
            </div>
          </div>
